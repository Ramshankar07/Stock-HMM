"""
Stock Price Forecaster Streamlit Application

This application forecasts stock prices using a Hidden Markov Model
based on historical stock price data. The application provides users
with the ability to view 1-day and multi-day forecasts for several major
